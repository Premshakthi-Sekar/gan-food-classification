...
| Property | Value |
|----------|-------|
| Total images | ~2,000–3,000 |
| Classes | 30 food categories |
| Annotation format | YOLO bounding boxes |
| Collection method | Custom refrigerator photography |
| Full dataset | [Available on Kaggle →](https://www.kaggle.com/datasets/ADD-YOUR-LINK-HERE) |

> 📦 **Full dataset** (images + YOLO annotations) available on Kaggle: [Add your Kaggle link here](https://www.kaggle.com/datasets/ADD-YOUR-LINK-HERE)
